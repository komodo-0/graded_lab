...
class MacieS3BucketAssociation(
    ...
    def generate_config_for_import(
        ...
        '''Generates CDKTF code for importing a MacieS3BucketAssociation resource upon running "cdktf plan ".

        :param scope: The scope in which to define this construct.
        :param import_to_id: The construct id used in the generated config for the MacieS3BucketAssociation to import.
        :param import_from_id: The id of the existing MacieS3BucketAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/macie_s3_bucket_association#import import section} in the documentation of this resource for the id to use
        :param provider: ? Optional instance of the provider where the MacieS3BucketAssociation to import is found.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__be2e6c3d60a2fb1ee2d594b25e6fa952cfe988277cb702697f74814e487f42ae)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
class MacieS3BucketAssociationClassificationTypeOutputReference(
    ...
    def one_time(self, value: builtins.str) -> None:
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "oneTime", value) # pyright: ignore[reportArgumentType]
...
def _typecheckingstub__be2e6c3d60a2fb1ee2d594b25e6fa952cfe988277cb702697f74814e487f42ae(
    scope: _constructs_77d1e7e8.Construct,
    import_to_id: builtins.str,
    import_from_id: builtins.str,
    provider: typing.Optional[_cdktf_9a9027ec.TerraformProvider] = None,
